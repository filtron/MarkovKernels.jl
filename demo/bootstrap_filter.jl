...
function update_weights!(P::ParticleSystem{T,U,<:AbstractVector}, L::AbstractLogLike) where {T,U}
...
function predict(rng::AbstractRNG, P::ParticleSystem{T,U,<:AbstractVector}, K::AbstractMarkovKernel) where {T,U}
    X = copy.(particles(P))
