...
# Define normal distribution parametrisations
...
# parametrisation independent functions
eltype(n::AbstractNormal{T,P}) where {T,U,V,P} = T
parametrisation(n::AbstractNormal{T,P}) where {T,U,V,P} = P
dim(N::Normal) = length(N.μ)

# functions for usual parametrisation
